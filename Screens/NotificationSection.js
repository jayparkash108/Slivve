...
import { Image, ScrollView, StatusBar, StyleSheet, Text, TextInput, useColorScheme, View } from 'react-native';
  ...
  return (
    <>
      ...
      <View style={{ backgroundColor: isDarkMode ? COLOURS.black : COLOURS.white, }}>
        ...
        <View style={{ alignItems: 'center', justifyContent: 'center', marginBottom: 10, marginTop: 10, }}>
          <Image source={require('../images/original-slivve.png')}
            style={{ justifyContent: 'center', alignItems: 'center', width: 120, height: 100, elevation: 41 }} resizeMode='contain'
      ...
      >
        ...
        <Tab.Screen name="ContactRequest" component={ContactRequest} options={{ tabBarLabel: 'Contact Request', }} />
      </Tab.Navigator>
